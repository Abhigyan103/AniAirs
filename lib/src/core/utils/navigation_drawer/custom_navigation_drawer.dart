...
class CustomNavigationDrawer extends StatelessWidget {
  ...
  final List<Widget>? backgroundStack;
  ...
  Widget build(BuildContext context) {
    final int totalNumberOfDestinations =
        children.whereType<CustomNavigationDrawerDestination>().toList().length;
    ...
    for (int i = 0; i < children.length; i++) {
      if (children[i] is! CustomNavigationDrawerDestination) {
...
class CustomNavigationDrawerDestination extends StatelessWidget {
